        ...
        <Card className="min-w-[167px] max-w-[167px] rounded-2xl">
            <CardContent className="p-1 px-1">
               ...
               <div className="w-full h-[159px] relative">
                ...
                <Image src={barbershop.imageUrl} style={{
                    objectFit: "cover",
                }} height={0} width={0} sizes="100vw" fill className="h-[159px] w-full rounded-2xl" alt={barbershop.name}/>
               </div>

               <div className="px-2 pb-3">
                    <h2 className="font-bold mt-2 overflow-hidden text-ellipsis text-nowrap">{barbershop.name}</h2>
                    <p className="text-som text-gray-400 overflow-hidden text-ellipsis text-nowrap">{barbershop.address}</p>
